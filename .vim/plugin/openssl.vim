...
function! s:OpenSSLReadPost()
    ...
    if l:cipher == "bfa"
        let l:cipher = "bf"
        let l:expr = "0,$!openssl " . l:cipher . " -d -a -salt -pbkdf2"
    else
        let l:expr = "0,$!openssl " . l:cipher . " -d -salt -pbkdf2"
    endif
...
function! s:OpenSSLWritePre()
    ...
    if l:cipher == "bfa"
        let l:cipher = "bf"
        let l:expr = "0,$!openssl " . l:cipher . " -e -a -salt -pbkdf2"
    else
        let l:expr = "0,$!openssl " . l:cipher . " -e -salt -pbkdf2"
    endif
